    ...
    public class InventoryRepository : IInventoryRepository
    {
        ...
        public InventoryRepository()
        {
            _inventories = new List<Inventory>()
            {
                ...
                new Inventory {InventoryId = 4, InventoryName = "Bike Light", Quantity = 10, Price = 2}
            };
        }
        ...
        {
            if (_inventories.Any(x =>
                    x.InventoryId != inventory.InventoryId && x.InventoryName.Equals(inventory.InventoryName,
